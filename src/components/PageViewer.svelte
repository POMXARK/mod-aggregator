<script lang="ts">
  ...
  import { useRecentUrls, usePageLoader, useSelection } from '@/lib/composables';
...
<style>
  @import '/src/styles/page-viewer.css';
</style>
