<script lang="ts">
  ...
  import { useParserSettings, type ParserSettings } from '../../lib/composables/useParserSettings.svelte.ts';
  import { useParserRunner } from '../../lib/composables/useParserRunner';
