<script lang="ts">
  ...
  import { PlusIcon, TrashIcon, PencilIcon } from './icons/index';
...
<div class="sites-manager">
  ...
  {#if showForm}
    <SiteForm site={editingSite} onClose={handleFormClose} onSubmit={handleFormSubmit} />
  {/if}
